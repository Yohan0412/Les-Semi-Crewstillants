  ...
  return (
      <footer className="footer">
        <div className="container-fluid logo-footer">
          ...
          <img className="m-2" src="src/assets/square-facebook.svg" 
            alt="Facebook" />
            <img className="m-2" src="src/assets/square-instagram.svg" 
            alt="Facebook" />
            <img className="m-2" src="src/assets/square-pinterest.svg" 
            alt="Facebook" />
          </div>
